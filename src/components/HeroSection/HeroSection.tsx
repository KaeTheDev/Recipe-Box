  ...
  return (
    <section className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4 pt-8 pb-8 sm:pt-12 sm:pb-12 md:pt-16 md:pb-16 space-y-4 sm:space-y-6 md:space-y-8">
        ...
        <div
          className="text-sm sm:text-base md:text-lg text-white/80 flex items-center justify-center gap-2
                border border-white/50 rounded-full px-4 py-2"
        >
          <Stars />
        ...
        {/* Description */}
        <p className="text-xs sm:text-sm md:text-lg lg:text-xl text-white/90 max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto">
          From quick weeknight dinners to impressive weekend feasts. Start
          exploring now!
        </p>
        ...
        <button
          ...
          className="mt-4 flex items-center gap-2 bg-white text-black px-6 py-3 rounded-full hover:bg-green-700 hover:text-white transition text-sm sm:text-base md:text-lg"
        >
